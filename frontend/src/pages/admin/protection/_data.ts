...
export const CATEGORIES: ProtectionCategory[] = [
  ...
  { id: 'cat-4', code: '2', label: '数据与组件可信', sub: 'TRUST', path: '/admin/secplane/cat-trust', color: '#6b21a8', count: 2 },
...
export const SCENARIOS: ProtectionScenario[] = [
  ...
  { id: 'e', code: 'E', label: '组件可信扫描', subtitle: '技能/插件/镜像供应链', path: '/admin/secplane/trust/component', cat: 'cat-4' },
  { id: 'sds', code: 'SDS', label: 'Skill 深度扫描', subtitle: '六分析器并行 · 含 LLM 语义 · 单技能代码级检测', path: '/admin/secplane/trust/skill-deepscan', cat: 'cat-4' },
